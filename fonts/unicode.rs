...
static GIGA_DICT: &[(IntentVector, Intent)] = &[
    ...
    (
        word_to_vector(&[0x0432, 0x044B, 0x0445, 0x043E, 0x0434]),
        Intent::Exit,
    ),
    // "свали" [с=0x0441 в=0x0432 а=0x0430 л=0x043B и=0x0438]
    (
        word_to_vector(&[0x0441, 0x0432, 0x0430, 0x043B, 0x0438]),
        Intent::Exit,
    ),
    // "exit" [e=0x65 x=0x78 i=0x69 t=0x74]
    (
        word_to_vector(&[0x0065, 0x0078, 0x0069, 0x0074]),
        Intent::Exit,
    ),
    // "quit" [q=0x71 u=0x75 i=0x69 t=0x74]
    (
        word_to_vector(&[0x0071, 0x0075, 0x0069, 0x0074]),
        Intent::Exit,
    ),
    // "cdfkb" (свали на EN раскладке)
    (
        word_to_vector(&[0x0063, 0x0064, 0x0066, 0x006B, 0x0062]),
        Intent::Exit,
    ),
    // "ds[jl" (выход на EN раскладке)
    (
        word_to_vector(&[0x0064, 0x0073, 0x005B, 0x006A, 0x006C]),
        Intent::Exit,
    ),
    // "اخرج" — арабское "выйди" [alif=0x0627 kha=0x062E ra=0x0631 jim=0x062C]
    (
        word_to_vector(&[0x0627, 0x062E, 0x0631, 0x062C]),
        Intent::Exit,
    ),
    // "გასვლა" — грузинское "выход"
    (
        word_to_vector(&[0x10D2, 0x10D0, 0x10E1, 0x10D5, 0x10DA, 0x10D0]),
        Intent::Exit,
    ),
    ...
    (
        word_to_vector(&[0x062E, 0x0631, 0x0648, 0x062C]),
        Intent::Exit,
    ),
    // ==================== HELP / ПОМОЩЬ (0x01) ====================
    ...
    (
        word_to_vector(&[0x043F, 0x043E, 0x043C, 0x043E, 0x0449, 0x044C]),
        Intent::Help,
    ),
    // "help"
    (
        word_to_vector(&[0x0068, 0x0065, 0x006C, 0x0070]),
        Intent::Help,
    ),
    // "?" — универсальный
    ...
    // "помоги"
    (
        word_to_vector(&[0x043F, 0x043E, 0x043C, 0x043E, 0x0433, 0x0438]),
        Intent::Help,
    ),
    // "مساعدة" — арабское "помощь"
    (
        word_to_vector(&[0x0645, 0x0633, 0x0627, 0x0639, 0x062F, 0x0629]),
        Intent::Help,
    ),
    // ==================== CLEAR / ОЧИСТКА (0x02) ====================
    ...
    // "clear"
    (
        word_to_vector(&[0x0063, 0x006C, 0x0065, 0x0061, 0x0072]),
        Intent::Clear,
    ),
    ...
    // "статус"
    (
        word_to_vector(&[0x0441, 0x0442, 0x0430, 0x0442, 0x0443, 0x0441]),
        Intent::Status,
    ),
    // "status"
    (
        word_to_vector(&[0x0073, 0x0074, 0x0061, 0x0074, 0x0075, 0x0073]),
        Intent::Status,
    ),
    // "حالة" — арабское "статус"
    (
        word_to_vector(&[0x062D, 0x0627, 0x0644, 0x0629]),
        Intent::Status,
    ),
    // ==================== REBOOT (0x04) ====================
    ...
    // "ребут"
    (
        word_to_vector(&[0x0440, 0x0435, 0x0431, 0x0443, 0x0442]),
        Intent::Reboot,
    ),
    // "reboot"
    (
        word_to_vector(&[0x0072, 0x0065, 0x0062, 0x006F, 0x006F, 0x0074]),
        Intent::Reboot,
    ),
    // "перезагрузка"
    (
    ...
    (
        word_to_vector(&[0x0627, 0x0639, 0x0627, 0x062F, 0x0629]),
        Intent::Reboot,
    ),
    // ==================== LOCALE CYCLE (0x20) ====================
    ...
    // "locale"
    (
        word_to_vector(&[0x006C, 0x006F, 0x0063, 0x0061, 0x006C, 0x0065]),
        Intent::LocaleCycle,
    ),
    // "локаль" [л=0x043B о=0x043E к=0x043A а=0x0430 л=0x043B ь=0x044C]
    (
        word_to_vector(&[0x043B, 0x043E, 0x043A, 0x0430, 0x043B, 0x044C]),
        Intent::LocaleCycle,
    ),
    // "язык" [я=0x044F з=0x0437 ы=0x044B к=0x043A]
    (
        word_to_vector(&[0x044F, 0x0437, 0x044B, 0x043A]),
        Intent::LocaleCycle,
    ),
    // "lang"
    (
        word_to_vector(&[0x006C, 0x0061, 0x006E, 0x0067]),
        Intent::LocaleCycle,
    ),
    // ==================== LOCALE RU (0x21) ====================
    ...
    // "arab"
    (
        word_to_vector(&[0x0061, 0x0072, 0x0061, 0x0062]),
        Intent::LocaleAr,
    ),
    // "عربي" — арабское "арабский" [ayn=0x0639 ra=0x0631 ba=0x0628 ya=0x064A]
    (
        word_to_vector(&[0x0639, 0x0631, 0x0628, 0x064A]),
        Intent::LocaleAr,
    ),
    // ==================== MODE LORE (0x24) ====================
    ...
    // "lore"
    (
        word_to_vector(&[0x006C, 0x006F, 0x0072, 0x0065]),
        Intent::ModeLore,
    ),
    ...
    (
        word_to_vector(&[0x0073, 0x0068, 0x0069, 0x007A, 0x0061]),
        Intent::ModeLore,
    ),
    // ==================== MODE TECH (0x25) ====================
    ...
    // "tech"
    (
        word_to_vector(&[0x0074, 0x0065, 0x0063, 0x0068]),
        Intent::ModeTech,
    ),
    ...
    // "apps"
    (
        word_to_vector(&[0x0061, 0x0070, 0x0070, 0x0073]),
        Intent::Apps,
    ),
    // "menu"
    (
        word_to_vector(&[0x006D, 0x0065, 0x006E, 0x0075]),
        Intent::Apps,
    ),
    // "launcher"
    (
    ...
    // "проги"
    (
        word_to_vector(&[0x043F, 0x0440, 0x043E, 0x0433, 0x0438]),
        Intent::Apps,
    ),
    // "меню"
    (
        word_to_vector(&[0x043C, 0x0435, 0x043D, 0x044E]),
        Intent::Apps,
    ),
    // "تطبيقات" (apps)
    (
        word_to_vector(&[0x062A, 0x0637, 0x0628, 0x064A, 0x0642, 0x0627, 0x062A]),
        Intent::Apps,
    ),
    // ==================== WHOAMI (0x40) ====================
    ...
    // "whoami"
    (
        word_to_vector(&[0x0077, 0x0068, 0x006F, 0x0061, 0x006D, 0x0069]),
        Intent::WhoAmI,
    ),
    ...
    (
        word_to_vector(&[0x006E, 0x0065, 0x0072, 0x006F]),
        Intent::Manifest,
    ),
    // "shiza"
    (
    ...
    (
        word_to_vector(&[0x043D, 0x0435, 0x0439, 0x0440, 0x043E]),
        Intent::Manifest,
    ),
    // "шиза" [ш=0x0448 и=0x0438 з=0x0437 а=0x0430]
    (
        word_to_vector(&[0x0448, 0x0438, 0x0437, 0x0430]),
        Intent::Manifest,
    ),
    // ==================== ENTROPY (0x42) ====================
    ...
    // "entropy"
    (
        word_to_vector(&[0x0065, 0x006E, 0x0074, 0x0072, 0x006F, 0x0070, 0x0079]),
        Intent::Entropy,
    ),
    ...
    (
        word_to_vector(&[0x0448, 0x0435, 0x043D, 0x043D, 0x043E, 0x043D]),
        Intent::Entropy,
    ),
    // "shannon"
    (
        word_to_vector(&[0x0073, 0x0068, 0x0061, 0x006E, 0x006E, 0x006F, 0x006E]),
        Intent::Entropy,
    ),
    // ==================== RNG (0x43) ====================
    ...
    // "rand"
    (
        word_to_vector(&[0x0072, 0x0061, 0x006E, 0x0064]),
        Intent::Rng,
    ),
    // "random"
    (
        word_to_vector(&[0x0072, 0x0061, 0x006E, 0x0064, 0x006F, 0x006D]),
        Intent::Rng,
    ),
    // "рандом" [р=0x0440 а=0x0430 н=0x043D д=0x0434 о=0x043E м=0x043C]
    (
        word_to_vector(&[0x0440, 0x0430, 0x043D, 0x0434, 0x043E, 0x043C]),
        Intent::Rng,
    ),
    // "кубик" [к=0x043A у=0x0443 б=0x0431 и=0x0438 к=0x043A]
    (
        word_to_vector(&[0x043A, 0x0443, 0x0431, 0x0438, 0x043A]),
        Intent::Rng,
    ),
    // ==================== VOODOO (0x44) ====================
    ...
    // "voodoo"
    (
        word_to_vector(&[0x0076, 0x006F, 0x006F, 0x0064, 0x006F, 0x006F]),
        Intent::Voodoo,
    ),
    // "вуду" [в=0x0432 у=0x0443 д=0x0434 у=0x0443]
    (
        word_to_vector(&[0x0432, 0x0443, 0x0434, 0x0443]),
        Intent::Voodoo,
    ),
    ...
    // "oracle" — оракул
    (
        word_to_vector(&[0x006F, 0x0072, 0x0061, 0x0063, 0x006C, 0x0065]),
        Intent::Voodoo,
    ),
    // "оракул" [о=0x043E р=0x0440 а=0x0430 к=0x043A у=0x0443 л=0x043B]
    (
        word_to_vector(&[0x043E, 0x0440, 0x0430, 0x043A, 0x0443, 0x043B]),
        Intent::Voodoo,
    ),
    ...
    (
        word_to_vector(&[0x72, 0x61, 0x65, 0x6C, 0x63]),
        Intent::Clear,
    ),
    // "sutats" ← status
    (
        word_to_vector(&[0x73, 0x75, 0x74, 0x61, 0x74, 0x73]),
        Intent::Status,
    ),
    // "toober" ← reboot
    (
        word_to_vector(&[0x74, 0x6F, 0x6F, 0x62, 0x65, 0x72]),
        Intent::Reboot,
    ),
    // "elacol" ← locale
    (
        word_to_vector(&[0x65, 0x6C, 0x61, 0x63, 0x6F, 0x6C]),
        Intent::LocaleCycle,
    ),
    // "gnal" ← lang
    (
        word_to_vector(&[0x67, 0x6E, 0x61, 0x6C]),
        Intent::LocaleCycle,
    ),
    // "ur" ← ru
    ...
    // "lacinhcet" ← technical
    (
        word_to_vector(&[0x6C, 0x61, 0x63, 0x69, 0x6E, 0x68, 0x63, 0x65, 0x74]),
        Intent::ModeTech,
    ),
    // "sapp" ← apps
    ...
    // "rehcnual" ← launcher
    (
        word_to_vector(&[0x72, 0x65, 0x68, 0x63, 0x6E, 0x75, 0x61, 0x6C]),
        Intent::Apps,
    ),
    // "imaohw" ← whoami
    (
        word_to_vector(&[0x69, 0x6D, 0x61, 0x6F, 0x68, 0x77]),
        Intent::WhoAmI,
    ),
    // "tsefinam" ← manifest
    (
        word_to_vector(&[0x74, 0x73, 0x65, 0x66, 0x69, 0x6E, 0x61, 0x6D]),
        Intent::Manifest,
    ),
    // "oren" ← nero
    ...
    // "yportne" ← entropy
    (
        word_to_vector(&[0x79, 0x70, 0x6F, 0x72, 0x74, 0x6E, 0x65]),
        Intent::Entropy,
    ),
    // "nonnahs" ← shannon
    (
        word_to_vector(&[0x6E, 0x6F, 0x6E, 0x6E, 0x61, 0x68, 0x73]),
        Intent::Entropy,
    ),
    // "gnr" ← rng
    ...
    // "modnar" ← random
    (
        word_to_vector(&[0x6D, 0x6F, 0x64, 0x6E, 0x61, 0x72]),
        Intent::Rng,
    ),
    // "oodoov" ← voodoo
    (
        word_to_vector(&[0x6F, 0x6F, 0x64, 0x6F, 0x6F, 0x76]),
        Intent::Voodoo,
    ),
    // "elcaro" ← oracle
    (
        word_to_vector(&[0x65, 0x6C, 0x63, 0x61, 0x72, 0x6F]),
        Intent::Voodoo,
    ),
];
...
pub fn lookup_intent(input: &[u32]) -> Intent {
    ...
    let len = if input.len() < MAX_WORD_LEN {
        input.len()
    } else {
        MAX_WORD_LEN
    };
