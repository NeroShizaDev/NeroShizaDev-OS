...
use crate::kernel_messages::{
    KernelEvent, Locale, MessageMode,
    get_event_text, locale_name, mode_name,
};
...
pub fn print_localized_fmt(color: u8, args: fmt::Arguments) {
    ...
    unsafe {
        ...
        match spec.direction {
            TextDirection::Ltr => write_codepoints_ltr_direct(buf.as_slice(), 24, 0, color, spec.numerals),
            TextDirection::Rtl => write_codepoints_rtl_direct(buf.as_slice(), 24, 79, color, spec.numerals),
        }
    }
...
pub unsafe fn render_panic_screen(ev: KernelEvent) {
    ...
    write_crash_text_at_vga("0xBEDABEDA01  \u{0441}\u{0438}\u{0441}\u{0442}\u{0435}\u{043C}\u{0430} \u{0441}\u{0434}\u{043E}\u{0445}\u{043B}\u{0430}!", 9, 2, ATTR_LORE);
    write_ascii_at_vga("/ system crashed!", 9, 27, ATTR_LORE);

    // --- Строка 11: модуль (имя события) ---
    write_crash_text_at_vga("\u{041C}\u{043E}\u{0434}\u{0443}\u{043B}\u{044C} / Module: ", 11, 2, ATTR_TEXT);
    ...
    if crate::trace::contains_recent("timer irq0 eoi sent") {
        write_crash_text_at_vga("\u{041F}\u{043E}\u{0441}\u{043B}\u{0435} IRQ0 \u{0432}\u{043E}\u{0437}\u{0432}\u{0440}\u{0430}\u{0442}\u{0430} / After IRQ0 return", 13, 2, ATTR_HINT);
    }
    if ev == KernelEvent::DoubleFault {
        if crate::trace::contains_recent("general protection handler entered") {
            write_crash_text_at_vga("\u{041F}\u{0435}\u{0440}\u{0432}\u{0438}\u{0447}\u{043D}\u{043E}: GP / Primary fault: GP", 14, 2, ATTR_HINT);
        } else if crate::trace::contains_recent("page fault handler entered") {
            write_crash_text_at_vga("\u{041F}\u{0435}\u{0440}\u{0432}\u{0438}\u{0447}\u{043D}\u{043E}: PF / Primary fault: PF", 14, 2, ATTR_HINT);
        } else if crate::trace::contains_recent("breakpoint handler entered") {
            write_crash_text_at_vga("\u{041F}\u{0435}\u{0440}\u{0432}\u{0438}\u{0447}\u{043D}\u{043E}: BP / Primary fault: BP", 14, 2, ATTR_HINT);
        } else if crate::trace::contains_recent("timer irq0 entered") {
            write_crash_text_at_vga("\u{041F}\u{0435}\u{0440}\u{0432}\u{0438}\u{0447}\u{043D}\u{043E}: IRQ0 / Primary fault: IRQ0", 14, 2, ATTR_HINT);
        }
    } else if ev == KernelEvent::GeneralProtection {
        write_crash_text_at_vga("GP \u{043F}\u{043E}\u{0439}\u{043C}\u{0430}\u{043D} / GP captured before DF", 14, 2, ATTR_HINT);
    }

    // --- Строки 18..22: последние действия ядра ---
    write_crash_text_at_vga("\u{041F}\u{043E}\u{0441}\u{043B}\u{0435}\u{0434}\u{043D}\u{0438}\u{0435} \u{0434}\u{0435}\u{0439}\u{0441}\u{0442}\u{0432}\u{0438}\u{044F} / Last actions:", 18, 2, ATTR_TEXT);
    let trace_len = crate::trace::len();
    let first = trace_len.saturating_sub(4);
    let mut row = 19usize;
    let mut idx = first;
    if trace_len == 0 {
        write_crash_text_at_vga("- \u{0442}\u{0440}\u{0435}\u{0439}\u{0441} \u{043F}\u{0443}\u{0441}\u{0442} / no trace recorded", 19, 2, ATTR_HINT);
    }
    ...
    // --- Строка 23: подсказка ---
    write_crash_text_at_vga("\u{0421}\u{0438}\u{0441}\u{0442}\u{0435}\u{043C}\u{0430} \u{043E}\u{0441}\u{0442}\u{0430}\u{043D}\u{043E}\u{0432}\u{043B}\u{0435}\u{043D}\u{0430} / System halted. Reset or power cycle.", 23, 9, ATTR_HINT);
}

fn trace_action_label(action: &'static str) -> &'static str {
    match action {
        "heap initialized" => "\u{043A}\u{0443}\u{0447}\u{0430} \u{0433}\u{043E}\u{0442}\u{043E}\u{0432}\u{0430} / heap initialized",
        "vga mapped + text mode" => "VGA \u{0433}\u{043E}\u{0442}\u{043E}\u{0432} / VGA mapped + text mode",
        "vga detect complete" => "VGA \u{043E}\u{043F}\u{0440}\u{043E}\u{0441} / VGA detect complete",
        "gdt idt pics fpu ready" => "CPU \u{0444}\u{0430}\u{0437}\u{0430} \u{0433}\u{043E}\u{0442}\u{043E}\u{0432}\u{0430} / CPU init ready",
        "rtc validator phase done" => "RTC \u{0438} validator \u{0433}\u{043E}\u{0442}\u{043E}\u{0432}\u{044B} / RTC validator done",
        "ps2 probe complete" => "PS/2 \u{043E}\u{043F}\u{0440}\u{043E}\u{0441} \u{0433}\u{043E}\u{0442}\u{043E}\u{0432} / PS/2 probe done",
        "font + locale ready" => "\u{0448}\u{0440}\u{0438}\u{0444}\u{0442}\u{044B} \u{0438} \u{043B}\u{043E}\u{043A}\u{0430}\u{043B}\u{044C} \u{0433}\u{043E}\u{0442}\u{043E}\u{0432}\u{044B} / font + locale ready",
        "shell prompt drawn" => "shell \u{0433}\u{043E}\u{0442}\u{043E}\u{0432} / shell prompt drawn",
        "interrupts enabled" => "\u{043F}\u{0440}\u{0435}\u{0440}\u{044B}\u{0432}\u{0430}\u{043D}\u{0438}\u{044F} \u{0432}\u{043A}\u{043B}\u{044E}\u{0447}\u{0435}\u{043D}\u{044B} / interrupts enabled",
        "timer irq0 entered" => "\u{0442}\u{0430}\u{0439}\u{043C}\u{0435}\u{0440} irq0 \u{0432}\u{0445}\u{043E}\u{0434} / timer irq0 entered",
        "timer irq0 eoi sent" => "\u{0442}\u{0430}\u{0439}\u{043C}\u{0435}\u{0440} irq0 EOI / timer irq0 eoi sent",
        "panic handler entered" => "panic \u{043E}\u{0431}\u{0440}\u{0430}\u{0431}\u{043E}\u{0442}\u{0447}\u{0438}\u{043A} / panic handler entered",
        "page fault handler entered" => "page fault \u{043E}\u{0431}\u{0440}\u{0430}\u{0431}\u{043E}\u{0442}\u{0447}\u{0438}\u{043A} / page fault handler entered",
        "general protection handler entered" => "GP \u{043E}\u{0431}\u{0440}\u{0430}\u{0431}\u{043E}\u{0442}\u{0447}\u{0438}\u{043A} / GP handler entered",
        "double fault handler entered" => "double fault \u{043E}\u{0431}\u{0440}\u{0430}\u{0431}\u{043E}\u{0442}\u{0447}\u{0438}\u{043A} / DF handler entered",
        "breakpoint handler entered" => "breakpoint \u{043E}\u{0431}\u{0440}\u{0430}\u{0431}\u{043E}\u{0442}\u{0447}\u{0438}\u{043A} / BP handler entered",
        _ => action,
    }
}
...
pub unsafe fn write_str_at_vga(s: &str, row: usize, start_col: usize, attr: u8) {
    ...
    debug_assert!(start_col < 80, "write_str_at_vga: start_col={} >= 80", start_col);
...
unsafe fn write_ascii_at_vga(s: &str, row: usize, start_col: usize, attr: u8) {
    ...
    debug_assert!(start_col < 80, "write_ascii_at_vga: start_col={} >= 80", start_col);
    let vga = 0xB8000 as *mut u8;
    let mut col = start_col;
...
unsafe fn write_crash_text_at_vga(s: &str, row: usize, start_col: usize, attr: u8) {
    ...
    debug_assert!(start_col < 80, "write_crash_text_at_vga: start_col={} >= 80", start_col);
    let vga = 0xB8000 as *mut u8;
    let mut col = start_col;
    for c in s.chars() {
        if col >= 80 { break; }
...
pub unsafe fn write_str_rtl_direct(s: &str, row: usize, end_col: usize, attr: u8) {
    ...
    debug_assert!(end_col < 80, "write_str_rtl_direct: end_col={} >= 80", end_col);
    let numerals = locale_spec(get_locale()).numerals;
    let vga = 0xB8000 as *mut u8;
...
pub unsafe fn write_hex_at_vga(val: u64, row: usize, start_col: usize, attr: u8) {
    ...
    debug_assert!(start_col + 15 < 80, "write_hex_at_vga: start_col={} overflows line", start_col);
...
pub unsafe fn write_hex32_at_vga(val: u32, row: usize, start_col: usize, attr: u8) {
    ...
    debug_assert!(start_col + 7 < 80, "write_hex32_at_vga: start_col={} overflows line", start_col);
...
pub unsafe fn write_crash_address(addr: u64) {
    ...
    write_crash_text_at_vga("\u{0410}\u{0434}\u{0440}\u{0435}\u{0441} / Address: 0x", 12, 2, ATTR_TEXT);
