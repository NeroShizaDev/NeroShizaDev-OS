...
pub fn is_forward() -> bool { unsafe { KEY_FORWARD } }
pub fn is_back()    -> bool { unsafe { KEY_BACK    } }
pub fn is_left()    -> bool { unsafe { KEY_LEFT    } }
pub fn is_right()   -> bool { unsafe { KEY_RIGHT   } }
