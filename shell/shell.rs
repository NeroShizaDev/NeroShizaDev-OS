...
use crate::print;
use crate::{
    beeper, chronos, doom, kernel_messages, locale,
    menger, rtc, unicode, unicode_blocks, unicode_categories,
    unicode_scripts, vga_buffer, vga_hw, vga_unicode,
};
            ...
            if SHELL.buffer_len > 0 {
                ...
                match intent {
                    ...
                    unicode::Intent::Help => {
                        ...
                        match locale::get_locale() {
                            kernel_messages::Locale::ArEg => {
                                locale::print_localized_line("=== محرك NeroShiza Unicode ===", 0x0E);
                            ...
                            kernel_messages::Locale::EnUs => {
                                locale::print_localized_line("=== NeroShiza Unicode Engine ===", 0x0E);
                                locale::print_localized_line("Unicode 17.0 / UTF-32 / UCS-4", 0x0E);
                            ...
                            kernel_messages::Locale::RuRu => {
                                ...
                                locale::print_localized_line("  lore/лор       - Режим NeroShiza", 0x0E);
                    ...
                    unicode::Intent::Doom => {
                        locale::render_event_auto(kernel_messages::KernelEvent::ShellDoomStart);
                        doom::init(&[]);
                        doom::run();
                    }
