// ============================================================
// WAD PARSER — no_std WAD-парсер для NeroShizaDev Doom
// ============================================================
...
// или передается как ссылка на статические данные.
// alloc::vec::Vec используется для хранения директории в памяти при необходимости.
// ============================================================
